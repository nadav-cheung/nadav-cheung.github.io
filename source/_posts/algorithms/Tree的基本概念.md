...
sticky: 3117
abbrlink: 6e5a1512
description: "本文简要介绍树的基本概念：树是由节点和边构成的层级结构，包括根、子树、度、叶子、深度等术语。常见类型有二叉树、二叉搜索树、平衡二叉树、红黑树等。重点阐述二叉树的定义、满二叉树、完全二叉树与斜二叉树，以及数组和链表两种存储方式。并概述前序、中序、后序和层序遍历方法，最后提及归并排序与快速排序与遍历的关联。"
---
